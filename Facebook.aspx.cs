	...
	public partial class Facebook : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (authorization == null)
			{
				...
				facebookClient.RequestUserAuthorization(scope: new[] { FacebookClient.Scopes.UserAboutMe});
			}
			else
			{
                ...
                this.nameLabel.Text = HttpUtility.HtmlEncode(oauth2Graph.Id) + " : " + HttpUtility.HtmlEncode(oauth2Graph.Name); ;
			}
		}
	}
}