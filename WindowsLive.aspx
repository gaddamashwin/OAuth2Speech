<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WindowsLive.aspx.cs" Inherits="OAuth2Speech.WindowsLive" %>
...
<body>
	...
	<asp:Panel runat="server" ID="localhostDoesNotWorkPanel" Visible="False">
		...
		<pre>127.0.0.1 test</pre>
		<p>
			Then access this sample via this url:
			<asp:HyperLink ID="publicLink" NavigateUrl="http://2Speech.us:59722/WindowsLive.aspx"
				runat="server">http://2Speech.us:59722/WindowsLive.aspx</asp:HyperLink></p>
	</asp:Panel>
	<div>
		Welcome,
